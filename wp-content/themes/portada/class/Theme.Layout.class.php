...
class Portada_ThemeLayout
{
	...
	function __construct()
	{
		...
		(
			...
			(
				'main'					=>	1,
				'name'					=>	__('Layout 100%','portada'),
				'short_name'			=>	__('100','portada'),
				'css_class_column'		=>	array('left'),
			),
			'50x50'						=>	array
			(
				'main'					=>	1,
				'name'					=>	__('Layout 50x50%','portada'),
				'short_name'			=>	__('50x50','portada'),
				'css_class_column'		=>	array('left','right'),
			),
			'33x33x33'					=>	array
			(
				'main'					=>	1,
				'name'					=>	__('Layout 33x33x33%','portada'),
				'short_name'			=>	__('33x33x33','portada'),
				'css_class_column'		=>	array('left','center','right'),
			),
			'33x66'						=>	array
			(
				'main'					=>	0,
				'name'					=>	__('Layout 33x66%','portada'),
				'short_name'			=>	__('33x66','portada'),
				'css_class_column'		=>	array('left','right'),
			),
			'66x33'						=>	array
			(
				'main'					=>	0,
				'name'					=>	__('Layout 66x33%','portada'),
				'short_name'			=>	__('66x33','portada'),
				'css_class_column'		=>	array('left','right'),
			),
			'25x25x25x25'				=>	array
			(
				'main'					=>	1,
				'name'					=>	__('Layout 25x25x25x25%','portada'),
				'short_name'			=>	__('25x25x25x25','portada'),
				'css_class_column'		=>	array('left','center-left','center-right','right'),
			),
			'25x75'						=>	array
			(
				'main'					=>	0,
				'name'					=>	__('Layout 25x75%','portada'),
				'short_name'			=>	__('25x75','portada'),
				'css_class_column'		=>	array('left','right'),
			),
			'75x25'						=>	array
			(
				'main'					=>	0,
				'name'					=>	__('Layout 75x25%','portada'),
				'short_name'			=>	__('75x25','portada'),
				'css_class_column'		=>	array('left','right'),
			)		
		);
	}
